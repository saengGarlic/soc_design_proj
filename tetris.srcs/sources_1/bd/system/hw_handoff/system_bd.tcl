...
proc create_root_design { parentCell } {
  ...
  set TFTLCD_R_0 [ create_bd_port -dir O -from 7 -to 3 TFTLCD_R_0 ]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M02_AXI [get_bd_intf_pins ps7_0_axi_periph/M02_AXI] [get_bd_intf_pins pushbutton_0/S00_AXI]
  ...
  connect_bd_net -net TFTLCD_NEW_0_TFTLCD_Hsync [get_bd_ports TFTLCD_Hsync_0] [get_bd_pins TFTLCD_NEW_0/TFTLCD_Hsync]
  connect_bd_net -net TFTLCD_NEW_0_TFTLCD_R [get_bd_ports TFTLCD_R_0] [get_bd_pins TFTLCD_NEW_0/TFTLCD_R]
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x43C30000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs TFTLCD_NEW_0/S00_AXI/S00_AXI_reg] SEG_TFTLCD_NEW_0_S00_AXI_reg
  create_bd_addr_seg -range 0x00010000 -offset 0x43C20000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs pushbutton_0/S00_AXI/S00_AXI_reg] SEG_pushbutton_0_S00_AXI_reg
