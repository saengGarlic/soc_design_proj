...
HD_PWD='D:/hyun/soc_proj/tetris/tetris.runs/system_TFTLCD_NEW_0_3_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_TFTLCD_NEW_0_3.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_TFTLCD_NEW_0_3.tcl
