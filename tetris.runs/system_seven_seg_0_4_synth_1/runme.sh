...
HD_PWD='D:/Hyun/soc_proj/tetris/tetris.runs/system_seven_seg_0_4_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_seven_seg_0_4.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_seven_seg_0_4.tcl
