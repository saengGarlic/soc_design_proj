...
HD_PWD='D:/Hyun/soc_proj/tetris/tetris.runs/system_pushbutton_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_pushbutton_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_pushbutton_0_0.tcl
